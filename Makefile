.PHONY: build test test-integration vet fmt run tidy db-up db-down db-reset generate-openapi-types help
...
generate-openapi-types: ## Re-generate packages/api-shop/openapi_gen.go from data/openapi.yaml (requires oapi-codegen on PATH)
