.PHONY: build test test-integration vet fmt run tidy db-up db-down db-reset generate help
...
generate: ## Re-generate Go types from data/openapi.yaml (requires oapi-codegen on PATH)
