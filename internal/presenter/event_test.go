...
func TestToCardPackPurchasedWire(t *testing.T) {
	t.Run("CardPackPurchasedEvent の wire 変換", func(t *testing.T) {
		t.Run("CardPackPurchasedEvent が渡されたとき、event_type と各フィールドが wire payload に反映される", func(t *testing.T) {
...
func TestToFactionAcquiredWire(t *testing.T) {
	t.Run("FactionAcquiredEvent の wire 変換", func(t *testing.T) {
		t.Run("FactionAcquiredEvent が渡されたとき、event_type と各フィールドが wire payload に反映される", func(t *testing.T) {
			ts := time.Date(2026, 1, 2, 3, 4, 5, 0, time.UTC)
...
func TestToPremiumUpdatedWire(t *testing.T) {
	t.Run("PremiumUpdatedEvent の wire 変換", func(t *testing.T) {
		t.Run("PremiumExpiresAt が設定されているとき、IsPremium と有効期限が wire payload に反映される", func(t *testing.T) {
			ts := time.Date(2026, 1, 2, 3, 4, 5, 0, time.UTC)
		...
		t.Run("PremiumExpiresAt が未設定のとき、IsPremium=false かつ PremiumExpiresAt=nil で反映される", func(t *testing.T) {
			ts := time.Date(2026, 1, 2, 3, 4, 5, 0, time.UTC)
