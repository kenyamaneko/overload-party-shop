...
// Service は webhook 駆動のサブスクリプションライフサイクルイベントを処理する。
...
func (s *Service) applySubChangeWithEvent(ctx context.Context, sub *apishop.Subscription, isPremium bool, expiresAt *time.Time) error {
...
func (s *Service) applySubChangeNoEvent(ctx context.Context, sub *apishop.Subscription) error {
